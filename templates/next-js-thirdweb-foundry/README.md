# Electroneum DApp Monorepo (Next.js + JS + thirdweb + Foundry)

Welcome to your Electroneum DApp monorepo! This project is pre-configured with a Next.js JavaScript frontend and a thirdweb + Foundry smart contract development environment.

## 📁 Project Structure

- **`frontend/`**: Web application (Next.js + JS + thirdweb SDK v5 + Tailwind CSS v4)
