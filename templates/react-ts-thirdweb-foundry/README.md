# Electroneum DApp Monorepo (React + TS + thirdweb + Foundry)

Welcome to your Electroneum DApp monorepo! This project is pre-configured with a React (Vite) TypeScript frontend and a thirdweb + Foundry smart contract development environment.

## 📁 Project Structure

- **`frontend/`**: Web application (React + TS + thirdweb SDK v5 + Tailwind CSS v4)
