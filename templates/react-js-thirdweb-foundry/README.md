# Electroneum DApp Monorepo (React + JS + thirdweb + Foundry)

Welcome to your Electroneum DApp monorepo! This project is pre-configured with a React (Vite) JavaScript frontend and a thirdweb + Foundry smart contract development environment.

## 📁 Project Structure

- **`frontend/`**: Web application (React + JS + thirdweb SDK v5 + Tailwind CSS v4)
